...
# dropping the 'child_alone'-category, since it has just zeros
...
def index():
    ...
    # Top 10 categories
    cat_sum = y.sum(axis=0)
    cat_sum.sort_values(ascending=False, inplace=True)
    ...
    graphs = [
        ...
        }, 
        {
            ...
            'layout': {
                'title': 'Top 10 categories with value counts',
                'yaxis': {
                    'title': "Count"
                },
                'xaxis': {
